    ...
    try {
        ...
        switch (option) {
            case 'previousMonths':
                ...
                console.log('Deleted expenses for previous months:', deletedExpenses);
                break;
            ...
            case 'previousWeeks':
                ...
                console.log('Deleted expenses for previous weeks:', deletedExpenses);
                break;

            case 'everything':
                // Logic to clear all expenses
                deletedExpenses = await Expense.deleteMany({ user: userId });
                console.log('Deleted all expenses:', deletedExpenses);
                break;
